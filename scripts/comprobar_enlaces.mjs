...
import { buildSituationGuides } from "../web/situation-model.js";
...
const situationLinks = buildSituationGuides(situations, buildExampleGuides(markdown, operations.procedures)).flatMap((guide) => guide.sources.map((source) => source.url));
