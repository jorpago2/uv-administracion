...
const [manual, situationsA, situationsB, situationsC, situationsD, glossary, funding, operations, academicProgrammes, academicSituationContext, personalResearchContext, contentAudit] = await Promise.all([
  readJson("manual.json"), readJson("situations.json"), readJson("situations-51-100.json"), readJson("situations-101-104.json"), readJson("situations-105.json"),
...
for (const situation of [...situationsA.situations, ...situationsB.situations, ...situationsC.situations, ...situationsD.situations]) {
...
entries.push(
  route("Mapa personal", "Relacionar méritos, ANECA CU y financiación", "Puntos y mínimos ANECA, sexenios, proyectos estatales y europeos afines al ICMUV", "catedratico CU ANECA sexenio quinquenio liderazgo tesis AEI PID ERC Pathfinder Chips JU fotonica semiconductores materiales neuromorfico meritos", "mapa-meritos/", 14),
