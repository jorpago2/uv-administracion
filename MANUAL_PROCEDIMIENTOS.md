...
1. Identifica en qué condición actúas: PDI funcionario, PDI laboral, investigador principal, tutor, miembro de tribunal, director de estructura, etc.
2. Comprueba si el procedimiento corresponde al Departamento, la ETSE, el ICMUV, un servicio central o una entidad externa como ANECA/CNEAI.
3. Consulta la convocatoria del año en curso. Los plazos de promoción, sexenios, quinquenios, complementos, sabáticos, OCA y TFG/TFM cambian cada curso.
4. Presenta la solicitud por la vía indicada. Un correo electrónico ordinario no sustituye al registro electrónico cuando la norma exige sede o instancia interna.
5. Conserva el justificante de registro, la versión firmada de los documentos y las notificaciones.
6. Si existe un plazo, calcula únicamente días hábiles cuando así lo indique la norma y comprueba los periodos declarados inhábiles por la UV.

### Jerarquía práctica

En caso de duda o conflicto debe aplicarse, de forma simplificada:

1. Derecho de la Unión Europea, Constitución y legislación estatal básica.
2. Legislación de la Generalitat Valenciana.
3. Estatutos de la Universitat de València.
4. Reglamentos y acuerdos generales de la UV.
5. Reglamentos de ETSE, DIE e ICMUV.
6. Acuerdos de CAT/CCA, comisiones, guías docentes, calendarios e instrucciones operativas.

Una instrucción inferior no puede eliminar un derecho reconocido por una norma superior.
...
| Sexenios reconocidos | Último sexenio vigente | Último sexenio inactivo |
|---:|---:|---:|
| 0 | 230 h | 230 h |
| 1 | 220 h | 230 h |
| 2 | 210 h | 230 h |
...
- El sexenio se considera vigente cuando legalmente todavía no es posible tener reconocido otro posterior.
- El número considerado es el que conste reconocido al inicio del curso.
- La dedicación asociada a un sexenio inactivo se conserva durante seis cursos para permitir obtener uno nuevo; después puede pasar a 230 horas, salvo con cinco o seis sexenios.
- El profesorado ayudante doctor parte de 180 horas.
- La dedicación mínima después de reducciones es, con carácter general, 120 horas.
- La reducción de 10 horas por tener 63 años o más no se aplica hasta el curso 2029-2030.

#### Régimen transitorio de tres sexenios

Durante 2026-2027, 2027-2028 y 2028-2029:

- CU con tres sexenios y el tercero vigente: 210 horas.
- Resto de PDI permanente a tiempo completo con tres sexenios y el tercero vigente: 170 horas.
- PDI permanente con tres sexenios y el tercero inactivo: 210 horas.
...
- Dirección de tesis defendida el curso anterior: 20 horas; 30 si tiene mención internacional. En codirección se reparte. Máximo ordinario: 60 horas por curso y persona.
...
3. Comprueba que asignaturas, grupos, idioma, TFG/TFM, prácticas externas y horas coinciden con la actividad real.
4. Solicita por escrito la corrección de discrepancias y conserva la respuesta.
5. No intercambies docencia de manera informal si el cambio afecta al POD, horario, idioma o responsabilidad de actas.

El [ACGUV 251/2025](https://www.uv.es/sgeneral/Reglamentacio/Doc/Professorat/2025_251_Criteris_OCA_2026-27.pdf) establece para 2026-2027, entre otras reglas, una equivalencia general de 10 horas por crédito, el cómputo de TFG y TFM y la obligación de que la oferta refleje con exactitud el idioma previsto. Una vez aprobada la OCA, los cambios quedan limitados a los supuestos admitidos por el propio acuerdo.
...
Ante una posible práctica fraudulenta:

1. Describe los hechos de manera objetiva y conserva las evidencias permitidas.
2. Identifica a la persona afectada.
3. Aplica el protocolo UV/ETSE vigente; evita improvisar registros físicos o acceso al contenido privado de dispositivos.
...
- Conserva el examen o entrega original y la rúbrica.
- Registra fecha y resultado de la revisión.
...
- pone el expediente a disposición del estudiante durante 2 días hábiles;
- concede 5 días hábiles para alegaciones;
- debe resolver en 15 días hábiles desde la reclamación;
- no puede agravar la situación inicial del estudiante;
- su resolución admite recurso de alzada ante el rectorado.

Fuente: [procedimiento UV de impugnación](https://www.uv.es/uvweb/universidad/es/estudios-postgrado/informacion-academica-administrativa/convocatorias-calificaciones/impugnacion-examenes-1285897761994.html), en aplicación de ACGUV 108/2017.
...
3. Si participan empresa, otro centro o proyecto financiado, comprueba desde el inicio confidencialidad, propiedad de resultados y protección de datos.
4. Orienta y supervisa, pero preserva el carácter autónomo e individual del trabajo.
...
- La comisión anuncia fecha, lugar y condiciones con antelación.
- Cuando hay tribunal, se compone normalmente de tres miembros; en TFM deben ser doctores salvo autorización excepcional.
- La defensa es pública, excepto cuando se haya autorizado una restricción por confidencialidad.
- La calificación puede impugnarse por el procedimiento general de evaluación.
...
1. Identifica qué información es confidencial y quién es su titular.
2. Formaliza el acuerdo entre estudiante y empresa/institución.
3. Solicita, si procede, defensa restringida y compromiso del tribunal.
4. Separa una memoria pública de los anexos confidenciales cuando lo permita la comisión.
5. Si existe una invención, comunícala a la UV antes de cualquier defensa o publicación que destruya la novedad.

Modelos oficiales: [Anexo I](https://www.uv.es/convenisestud/TFG-TFM/Annex-I-autorellenable.pdf), [Anexo II](https://www.uv.es/convenisestud/TFG-TFM/Annex-II-autorellenable.pdf) y [Anexo III](https://www.uv.es/convenisestud/TFG-TFM/Annex-III-autorellenable.pdf).
...
Como tutor académico corresponde:

1. Establecer el plan tutorial y el programa formativo.
2. Realizar seguimiento efectivo.
3. Coordinarse con el tutor de la entidad.
4. Informar de incidencias al coordinador de prácticas.
5. Evaluar conforme a la guía docente y remitir el expediente completo.

Para prácticas curriculares de grado, el expediente de evaluación incluye al menos acuerdo de prácticas, memoria final, justificantes formativos y solicitud de evaluación. El tutor externo remite su valoración confidencialmente.

> [!WARNING]
> El documento ETSE de 2026 cita el RD 1707/2011. Ese real decreto fue anulado; el marco estatal actualmente utilizado es el **RD 592/2014**, incluido en el repositorio normativo. Debe interpretarse la norma ETSE junto con el Reglamento UV ACGUV 213/2024 y el RD 592/2014. Conviene pedir a la ETSE una corrección formal de la referencia.
...
|---|---|---:|
| Hasta 1 mes | Dirección del DIE, por delegación | 3 días |
| Más de 1 mes y hasta 3 | Vicerrectorado competente, con informe del DIE | 20 días |
| Más de 3 meses | Vicerrectorado competente, con informe del DIE | 2 meses |
...
- invitación o aceptación del centro receptor;
- resolución de ayuda o beca, si existe.
...
Al finalizar el sabático debe presentarse una memoria de actividades a la Comisión de Investigación en el plazo de **3 meses**. Su ausencia o evaluación negativa impide solicitar otro.

> [!CAUTION]
> El texto interno aún contiene denominaciones y remisiones antiguas —por ejemplo, permisos que han cambiado de nombre o régimen—. Para nacimiento, cuidados, incapacidad, lactancia, permiso parental, violencia de género o reducciones de jornada debe confirmarse la norma superior vigente con RR. HH. PDI.
...
1. Mantén actualizadas acreditación y hoja de servicios.
2. Revisa la convocatoria anual de RR. HH. PDI.
3. Presenta la solicitud al DIE por la instancia y grupo destinatario indicados ese año.
4. Conserva el justificante; no presupongas que el departamento iniciará el trámite de oficio.
...
- **Complemento autonómico:** convocatoria anual y requisitos diferenciados para PDI funcionario y laboral. No debe confundirse con sexenios o quinquenios.
...
- confirma alta de la clave específica y disponibilidad del crédito;
- conoce fecha inicial/final y reglas de elegibilidad;
- separa requisitos de la convocatoria, normativa UV y normativa de contratación;
- solicita autorizaciones para cambios de equipo, presupuesto o plazo;
- conserva evidencia de necesidad, entrega, pago, difusión y vinculación con el proyecto;
- en fondos MRR, tramita DACI y controles MINERVA/CoFFEE antes del gasto cuando proceda.
...
1. Contacta con la Sección de I+D+i Contratada (`sti.contractada@uv.es`).
2. Define entidad, objeto, entregables, duración, presupuesto, impuestos, equipo, confidencialidad, datos y propiedad de resultados.
3. Completa la solicitud electrónica, presupuesto estimado, declaración sobre resultados y las DACI de todas las personas UV participantes.
4. El Servicio prepara/revisa el instrumento jurídico.
5. Obtén la autorización previa del Departamento, ICMUV o ERI, certificada por su secretaría.
6. Espera a la firma institucional antes de iniciar la actividad o facturar.
7. Solicita formalmente cualquier cambio de equipo antes de finalizar la actividad.

Fuente: [procedimiento UV para contratos y convenios](https://www.uv.es/uvweb/servicio-investigacion/es/gestion-tramites-normativa/procedimento-solicitud-tramitacion-contratos-convenios-1286310687057.html).
...
3. Descarga el formulario de comunicación de resultado.
4. Complétalo, conviértelo a PDF y obtén la firma electrónica de todas las personas inventoras/autoras.
5. Adjunta exposición detallada; para software, también código fuente, ejecutable, manuales o diagramas requeridos.
6. Presenta la comunicación por sede al Servicio de Transferencia e Innovación.
7. Informa de cualquier fecha prevista de artículo, congreso, tesis o TFG/TFM.
8. Espera la evaluación sobre patente, propiedad intelectual, diseño, secreto u otra estrategia.

Las invenciones deben comunicarse en **3 meses desde su conclusión** y siempre antes de divulgar. La titularidad de resultados obtenidos en el ejercicio de funciones investigadoras corresponde normalmente a la UV, sin perjuicio de cotitularidades y del derecho del personal inventor a participar en beneficios.

Fuente y trámite: [comunicación de resultados protegibles](https://www.uv.es/uvweb/servicio-investigacion/es/gestion-tramites-normativa/comunicacion-nuevos-resultados-investigacion-protegibles-1286318132547.html) y [Reglamento UV ACGUV 328/2023](https://www.uv.es/serinves/docs/ln6_norm_patents.pdf).
...
- servicios o suministros: menos de 15.000 €;
- determinados servicios o suministros de investigación de la disposición adicional 54 de la LCSP: hasta 50.000 €;
- acceso a bases de datos y suscripciones: límite específico de contratos sujetos a regulación armonizada.
...
- No exige normalmente constancia documental de ofertas, salvo obras.
...
3. Se selecciona la oferta y se genera resolución de adjudicación.
4. Se tramita simultáneamente el documento AD.
5. Solo después de la firma se comunica el pedido al adjudicatario.
6. La factura debe tener fecha posterior a la resolución de adjudicación.
7. Tras recibir el bien/servicio, la persona solicitante valida el acta de recepción.

Se exigen al menos tres presupuestos de empresas que no pertenezcan al mismo grupo cuando el valor estimado sea igual o superior a 6.000 € en servicios o suministros, o a 30.000 € en obras, bases de datos y suscripciones. Por debajo de esos umbrales basta una oferta, aunque comparar varias sigue siendo recomendable.
...
1. Informa a la persona responsable del laboratorio y a la estructura.
2. Revisa evaluación de riesgos, manual, marcado y requisitos de instalación.
3. Asegura formación, procedimientos, EPIs y protecciones colectivas.
4. Comprueba residuos, ventilación, interbloqueos, señalización y respuesta ante emergencias.
5. Solicita evaluación al Servicio de Prevención cuando cambien las condiciones de trabajo.

La UV mantiene [pautas específicas para laboratorios de informática y electrónica](https://www.uv.es/uvweb/servicio-prevencion-medio-ambiente/es/salud-prevencion/unidades/unidad-higiene/laboratorios-1285902730371.html).

Ante accidente grave: proteger, avisar y socorrer, sin exponerse a un segundo accidente. Utiliza 112 y los teléfonos de emergencia del campus vigentes. Comunica el accidente al responsable y al Servicio de Prevención para su registro e investigación.
...
1. Comprueba si es una actividad exceptuada o requiere compatibilidad.
2. No asumas que un contrato artículo 60, una factura externa o trabajar fuera del horario elimina el régimen de incompatibilidades.
3. Solicita compatibilidad a RR. HH. PDI antes de iniciar la actividad cuando proceda.
4. Declara conflictos de interés en proyectos, contratación, selección, evaluación o compras.
5. Abstente formalmente cuando concurra una causa legal; no basta con no votar si se participa en la preparación o deliberación.
6. No utilices personal, equipos, datos o instalaciones UV para actividad privada sin cobertura institucional.

Normas de partida: Ley 53/1984, RD 598/1985, LOSU, Estatutos UV y regulación de contratos artículo 60.
...
3. Obtén expediente, informes y documentos relevantes.
4. Presenta el recurso por registro/sede, dirigido al órgano indicado.
5. No confundas una petición informal de revisión con un recurso que interrumpa o preserve plazos.
