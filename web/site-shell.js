  ...
  connectedCallback() {
    ...
    this.innerHTML = `
      <footer class="hub-footer">
        ...
        <nav aria-label="Enlaces de cierre"><a href="${root}auditoria/">Auditoría</a><a href="${root}glosario/">Glosario</a><a href="${root}consulta.html">Vista completa · pesada</a><a href="${root}MANUAL_PROCEDIMIENTOS.md">Markdown</a></nav>
      </footer>`;
  }
}
