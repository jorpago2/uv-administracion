...
const routes = [
  ...
  "docencia/index.html", "carrera-pdi/index.html", "plan-carrera/index.html", "mapa-meritos/index.html", "investigacion/index.html", "gestion/index.html",
...
test("el indice ligero solo genera destinos internos seguros", () => {
  ...
  for (const entry of searchIndex) {
    ...
    assert.ok(["example.html", "manual", "financiacion", "herramientas", "glosario", "investigacion", "programas", "auditoria", "plan-carrera", "mapa-meritos"].includes(firstSegment), `${entry.title}: ${entry.href}`);
  }
});
