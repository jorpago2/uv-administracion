...
const budget = JSON.parse(await readFile(new URL("../data/situations-105.json", import.meta.url), "utf8"));
...
const guides = buildSituationGuides(combineSituationCatalogs(situations, extension, specialised, budget), buildExampleGuides(manual.markdown, operations.procedures), academic, personal);

test("las seis áreas reparten las 105 situaciones sin huecos ni duplicados", () => {
  const expectedCounts = { planificacion: 5, docencia: 21, pdi: 14, investigacion: 40, gestion: 18, cumplimiento: 7 };
